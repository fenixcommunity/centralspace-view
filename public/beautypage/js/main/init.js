...
const launchBeautypageInitScript = () => {
  /********************
   * Helper Functions *
   ********************/
    ...
    var stepper = new MStepper(stepperDiv,
      {
        ...
        feedbackPreloader: '<div class="spizznner-layer spinner-blue-only">...</div>'
      }
    );
...
(function ($) {
  $(document).ready(function () {
    launchBeautypageInitScript();
    document.launchBeautypageInitScript = function () {
      return launchBeautypageInitScript();
    };
  });
}(jQuery));