...
function GalleryItems() {
    return (
        <>
            <div className="col l4 m6 s12 gallery-item gallery-expand gallery-filter overhead">
                <GalleryItemSpecial />
            </div>
            ...
            <div className="col l4 m6 s12 gallery-item gallery-expand gallery-filter overhead">
                <div className="gallery-curve-wrapper">
                    ...
                    <div className="gallery-action">
                        <a className="btn-floating btn-large waves-effect waves-light pink">
            ...
            <div className="col l4 m6 s12 gallery-item gallery-expand gallery-filter sintel">
                <div className="gallery-curve-wrapper">
                    <a
                        className="gallery-cover gray"
                        style={{
